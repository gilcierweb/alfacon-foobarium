          ...
          <v-card class="card-bg-details">
            ...
            <v-card-title>
              <NuxtLink :to="`/users/${post.user_id}`">
                ...
                <h3 class="text-h5 font-weight-bold card-title-color ma-3">{{ post.user_name }}</h3>
              </NuxtLink>
              <span class="text-h6 font-weight-light card-title-span-color ma-3">{{
                  post.user_posts_count
                }} posts</span>
            </v-card-title>
            <v-card-text>
              {{ post.body }}
